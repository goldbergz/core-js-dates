...
function formatDate(date) {
  ...
  const secods = String(newDate.getUTCSeconds()).padStart(2, '0');
  ...
  return `${month}/${day}/${year}, ${hours}:${minutes}:${secods} ${partDay}`;
}
...
function getNextFridayThe13th(date) {
  ...
  throw new Error('Не удалось найти пятницу 13-е в ближайшие два года.');
}
